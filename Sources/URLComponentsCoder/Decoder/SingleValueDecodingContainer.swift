...
extension Namespace.SingleValueContainer: SingleValueDecodingContainer {    
    func decodeNil() -> Bool {
    ...
    func decode<T>(_ type: T.Type) throws -> T where T : Decodable {
        let decoder = TopLevel.AliasesMap.Decoder.init()
        return try decoder.decode(type, from: self.data)
    }
}

extension Namespace.SingleValueContainer: URLComponentsDecodingContainer {}
